...
public interface MiniCListener extends ParseTreeListener {
	 ...
	 */
	void enterStruct_stmt(@NotNull MiniCParser.Struct_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniCParser#struct_stmt}.
	 * @param ctx the parse tree
	 */
	void exitStruct_stmt(@NotNull MiniCParser.Struct_stmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MiniCParser#struct_fun}.
	 * @param ctx the parse tree
	 */
	void enterStruct_fun(@NotNull MiniCParser.Struct_funContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniCParser#struct_fun}.
	 * @param ctx the parse tree
	 */
	void exitStruct_fun(@NotNull MiniCParser.Struct_funContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MiniCParser#struct_type}.
	 * @param ctx the parse tree
	 */
	void enterStruct_type(@NotNull MiniCParser.Struct_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link MiniCParser#struct_type}.
	 * @param ctx the parse tree
	 */
	void exitStruct_type(@NotNull MiniCParser.Struct_typeContext ctx);
	/**
